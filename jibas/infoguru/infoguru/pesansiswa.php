...
$tgl=date('j');
$bln=date('m');
$sql_ultah="SELECT nama FROM jbsakad.siswa WHERE DATE(tgllahir)='$tgl' AND MONTH(tgllahir)='$bln' ORDER BY nama";
...
<body class="twoColHybLt" onload="MM_preloadImages('pesanmasuk_on.png','pesanmasuk.png')">
...
<div id="container">
  ...
  <tr>
    <td><table border="0" cellpadding="0" cellspacing="0" align="center">
      <tr>
        <td><a href="javascript:;" target="_top" onclick="MM_nbGroup('down','group1','inbox','pesanmasuk_on.png',1)" onmouseover="MM_nbGroup('over','inbox','pesanmasuk_on.png','pesanmasuk.png',1)" onmouseout="MM_nbGroup('out')"><img src="pesanmasuk.png" alt="" name="inbox" width="120" height="24" border="0" id="inbox" onload="" /></a></td>
      </tr>
      <tr><td height="10">&nbsp;</td>
      </tr>
      <tr>
        <td><a href="javascript:;" target="_top" onclick="MM_nbGroup('down','group1','compose','tulispesan_on.png',0)" onmouseover="MM_nbGroup('over','compose','tulispesan_on.png','tulispesan.png',0)" onmouseout="MM_nbGroup('out')"><img src="tulispesan.png" alt="" name="compose" width="120" height="24" border="0" id="compose" onload="" /></a></td>
      </tr>
       <tr><td height="10">&nbsp;</td>
      <tr>
