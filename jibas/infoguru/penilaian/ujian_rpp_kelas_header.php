...
<html>
<head>
<title>Class Exam Index by Lesson Plans</title>
...
<tr>
    ...
    <td align="left" valign="middle" width="*" rowspan="2">
        <img src="../images/ico/view.png" width="48" height="48" border="0" onClick="show()" id="tabel" style="cursor:pointer;" OnMouseOver="showhint('Click to show class average exam', this, event, '150px')">            </td>
     <td align="right" valign="top" width="374" rowspan="2">
         <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Lesson Plans Index for each Classes</font><br />
        <a href="../penilaian.php" target="framecenter"> <font size="1" color="#000000"><b>Index</b></font></a>&nbsp;>&nbsp; <font size="1" color="#000000"><b>Lesson Plans Index for each Classes</b></font>
  	</td>
</tr>	
</table>
</form>
