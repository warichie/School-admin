function change_dept()
{
    ...
    document.location.href = "lap_legger_header.php?departemen="+departemen;
    parent.footer.location.href = "lap_legger_blank.php";
}
...
function change_ta()
{
    ...
    document.location.href = "lap_legger_header.php?departemen="+departemen+"&tahunajaran="+tahunajaran;
    parent.footer.location.href = "lap_legger_blank.php";
}
...
function change_tingkat()
{
    ...
    document.location.href = "lap_legger_header.php?tingkat="+tingkat+"&departemen="+departemen+"&tahunajaran="+tahunajaran;
    parent.footer.location.href = "lap_legger_blank.php";
}
...
function change_kelas()
{
    ...
    document.location.href = "lap_legger_header.php?tingkat="+tingkat+"&kelas="+kelas+"&departemen="+departemen+"&tahunajaran="+tahunajaran;
    parent.footer.location.href = "lap_legger_blank.php";
}
...
function change_semester()
{
    ...
    document.location.href = "lap_legger_header.php?tingkat="+tingkat+"&kelas="+kelas+"&departemen="+departemen+"&tahunajaran="+tahunajaran+"&semester="+semester;
    parent.footer.location.href = "lap_legger_blank.php";
}
...
function show()
{
    ...
    parent.footer.location.href = "lap_legger_content.php?departemen="+departemen+"&tingkat="+tingkat+"&semester="+semester+"&kelas="+kelas+"&pelajaran="+pelajaran+"&tahunajaran="+tahun;
    return true;
}
