...
<? 	$sql_cek_ujian = "SELECT u.replid, u.tanggal, u.deskripsi, u.idrpp 
	...
	$jumlahujian = @mysql_num_rows($result_cek_ujian); ?>            
        ...
        <br />
  		<table border="1" width="100%" id="table" class="tab">
       	<tr>
            <td height="30" bgcolor="#666666" width="5"><font color="white"><strong>#</strong></font></td>
    		<td height="30" bgcolor="#666666"><font color="white"><strong>Student ID</strong></font></td>
    		<td height="30" bgcolor="#666666"><font color="white"><strong>Name</strong></font></td>
    <?
  ...
  <?
    ...
    <tr>
    	<td><strong><font color="blue">)*</font> No info &nbsp;&nbsp; 
