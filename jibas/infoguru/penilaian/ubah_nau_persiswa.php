...
if(isset($_REQUEST["ubah"]))
{
   ...
   QueryDb($sql_simpan);
	...
	$sql_simpan = "UPDATE jbsakad.nau SET nilaiAU='$nilai', keterangan='Final Point changed manually' WHERE replid='$replid'";
...
<tr>
	...
	<table border="0" width="95%" cellpadding="2" cellspacing="2" align="center">
   	<!-- TABLE CONTENT -->
    <tr height="25">
        <td colspan="2" class="header" align="center">Edit Exam Final Point</td>
    </tr> 
