...
function change_tahunajaran(panel) 
{	
	if (panel == 4)
	{
		var nis = document.panel4.nis.value;
                    ...
                    <td width="100%" bgcolor="#FFFFFF" valign="top" colspan="2">
                        ...
                        <div id="TabbedPanels1" class="TabbedPanels">
                            <ul class="TabbedPanelsTabGroup">
                                ...
                                <li class="TabbedPanelsTab">Personal Notes</li>
                                <li class="TabbedPanelsTab">Class Subject Notes</li>
                                <li class="TabbedPanelsTab">Daily Notes</li>
