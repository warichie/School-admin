...
<tr>
    ...
    <td><strong>
    	<input type="text" name="nip" id="nip" size="10" class="disabled" value="<?=$_REQUEST['nip'] ?>" readonly/>
        <input type="hidden" name="nipguru" id="nipguru" value="<?=$_REQUEST['nip'] ?>"/>
    	<input type="text" name="nama" id="nama" size="20" class="disabled" value="<?=$_REQUEST['nama']?>" readonly/>
