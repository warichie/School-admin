...
if (isset($_REQUEST['Simpan'])) 
{
	...
	{
		CloseDb();		
		$ERROR_MSG = "Aspect $aspek has been used";
	} 
	else 
	{
		for ($i = 1; $i <= 10; $i++) 
...
<title>JIBAS TEACHERS INFO [Add Grade Point Rules]</title>
...
<!-- TABLE CONTENT -->
<tr height="25">
<td class="header" colspan="2" align="center">Add Grade Point Rules</td>
</tr>
<tr>
