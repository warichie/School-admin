...
<div id="title" align="right">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td  align="left">
			<? if($sender!='opac'){ ?>
            <a href="javascript:cetak(<?=$replid?>)"><img src="../images/ico/print.png" width="16" height="16" border="0" />&nbsp;Print</a>&nbsp;&nbsp;
            <? } ?>
			<!--<a href="javascript:cetak_nomor(<?=$replid?>)"><img src="../img/ico/print1.png" width="16" height="16" border="0" />&nbsp;Print&nbsp;Label</a>&nbsp;&nbsp;-->
			<a href="javascript:window.close()"><img src="../images/ico/hapus.png" border="0" />&nbsp;Close</a>		</td>
        <td  align="right">
