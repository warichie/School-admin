          ...
          <tr>
            <td width="305" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td height="25" align="right" valign="top">&nbsp;<a href="#" onClick="document.location.href='viewallguru.php?id=<?=$idsiswa?>'"><em>View All <span class="style4">(<?=$jumguru?>)</span> ...</em></a></td>
                  </tr>
                  <tr>
                    <td colspan="3">
                        <table width="100%" border="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td height="25" valign="top">&nbsp;</td>
                    <td height="25" align="right" valign="top">&nbsp;<a href="#" onClick="document.location.href='viewallsiswa.php?id=<?=$idsiswa?>'"><em>View All <span class="style4">(<?=$jumsiswa?>)</span> ...</em></a></td>
                  </tr>
                  <tr>
                    <td colspan="3">
                    	<table width="100%" border="0" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="3">
						<div align="right">
						  ...
						  <? } else { ?>
						  <input onClick="document.location.href='view_profil_siswa.php?op=komen&replid=<?=$replid?>'" name="komentar" type="button" class="but" value="Write Comment">
						  <? } ?>					
					  </div></td>
                  </tr>
                  <tr>
            ...
            <td valign="top"><table width="100%" border="0" cellspacing="0">
			  ...
			  <tr><?		
					...
					?>
                <td width="25%"><div align="center"><a href="<?=$WEB_GALLERY_DIR_IS?>photos/<?=$row_foto[filename]?>" rel="lytebox[vacation]"  >
				<!--onClick="lihat_gambar('../library/gambar.php?replid=<?=$row_foto[replid]?>&table=jbsvcr.galerifoto')"--><img src="<?=$WEB_GALLERY_DIR_IS?>thumbnail/<?=$row_foto[filename]?>" width="80" style="cursor:pointer;"><br>
			  ...
			  <?
				while ($row_fot=@mysql_fetch_array($res_fot)){
					?>
                <td width="25%"><div align="center"><a href="<?=$WEB_GALLERY_DIR_IS?>photos/<?=$row_fot[filename]?>" rel="lytebox[vacation]"  ><img   src="<?=$WEB_GALLERY_DIR_IS?>thumbnail/<?=$row_fot[filename]?>" width="80" style="cursor:pointer;"><br>
