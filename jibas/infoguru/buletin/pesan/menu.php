...
<table width="150" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	<td width="31"><a href="#" onclick="go('pesan_inbox');" title="Your Inbox" ><img src="../../images/ico/inbox.png" border="0" /></a></td>
  ...
  <tr>
    <td><a href="#" onclick="go('pesanguru_add_main');" title="Write Message to Teacher" ><img src="../../images/ico/compose.png" width="31" height="25" border="0" /></a></td>
    <td class="style8"><a style="text-decoration:none; color:#666666" href="#" title="New Message" class="style11" onclick="go('pesanguru_add_main');" >Write Message to Teacher</a></td>
  </tr>
  <tr>
    <td><a href="#" onclick="go('pesansiswa_add_main');" title="Write Message to Student" ><img src="../../images/ico/compose.png" width="31" height="25" border="0" /></a></td>
    <td class="style8"><a style="text-decoration:none; color:#666666" href="#" title="New Message" class="style11" onclick="go('pesansiswa_add_main');" >Write Message to Student</a></td>
  </tr>
  <tr>
    <td><a href="#" onclick="go('pesan_terkirim');" title="Sent Message List" ><img src="../../images/ico/sent.png" width="31" height="25" border="0" /></a></td>
