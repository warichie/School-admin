...
OpenDb();
$sql="INSERT INTO jbsvcr.pesan SET tanggalpesan='".$tanggalpesan." ".$jampesan."', tanggaltampil='$tanggaltampil',judul='$judul',pesan='$pesan',idguru='$idguru',nis=NULL,keguru=1";
$result=QueryDb($sql);
CloseDb();
