...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <th colspan="3" scope="row" align="left" bgcolor="#FFFFFF" height="30"><fieldset><legend>Attachment</legend>
    <table width="100%" border="1" cellspacing="0">
  <tr id="tr1" >
    <th width="2%" scope="row">#1</th>
    <th width="36%" scope="row"><?=$row1['namafile']?></th>
    <th width="62%" scope="row"><div align="left"><img src="../../images/ico/hapus.png" onclick="hapusfile1()" title="Delete this file" style="cursor:pointer" /><input type="hidden" size="1" name="d1" id="d1" value="0"/></div></th>
  </tr>
  <tr id="tr2" >
    <th scope="row">#2</th>
    <th scope="row"><?=$row2['namafile']?></th>
    <th scope="row"><div align="left"><img src="../../images/ico/hapus.png" onclick="hapusfile2()" title="Delete this file" style="cursor:pointer" /><input type="hidden" name="d2" id="d2" size="1" value="0" /></div></th>
  </tr>
  <tr id="tr3" >
    <th scope="row">#3</th>
    <th scope="row"><?=$row3['namafile']?></th>
    <th scope="row"><div align="left"><img src="../../images/ico/hapus.png" onclick="hapusfile3()" title="Delete this file" style="cursor:pointer" />
