              ...
              <tr>
              	<td colspan="2" align="right">
              		<? if ($row1[idpengirim]==$idguru){ ?>
                        <img src="../../images/ico/ubah.png" border="0" onclick="ubah('<?=$row1[replid]?>','<?=$page?>')" style="cursor:pointer;" title="Edit this News" />&nbsp;<img src="../../images/ico/hapus.png" border="0" onclick="hapus('<?=$row1[replid]?>','<?=$page?>')" style="cursor:pointer;" title="Delete this News" />
	                <? } ?>              	</td>
              </tr>
            </table>
            <br />
