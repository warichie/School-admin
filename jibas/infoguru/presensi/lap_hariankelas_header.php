...
<title>JIBAS SIMAKA [Student Daily Presence Reports by Classes]</title>
...
<tr>	
    ...
    <td width="*" rowspan="3" align="left" valign="middle"><a href="#" onclick="tampil()" ><img src="../images/ico/view.png" onmouseover="showhint('Click to show laporan presensi harian per kelas', this, event, '100px')" height="48" width="48" border="0" name="tabel" id="tabel"/></a></td>
        <td width="*" align="right" valign="top">
        <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Daily Presence Report by Classes</font><br />
    <a href="../presensi.php" target="framecenter">
      <font size="1" color="#000000"><b>Presence</b></font></a>&nbsp;>&nbsp;
        <font size="1" color="#000000"><b>Daily Presence Report by Classes</b></font>
        </td>     
    </tr>
	</table>
    </td>
