...
<title>Presence Statistic for each Students</title>
...
<tr>	
	...
	<td align="left" valign="middle"><a href="#" onclick="tampil()" ><img src="../images/ico/view.png"  onmouseover="showhint('Click to show Presence Statistic for each students', this, event, '100px')" height="48" border="0" name="tabel" id="tabel"/></a></td>
        <td width="*" align="right" valign="top">
        <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Presence Statistic for each Students</font><br />
    <a href="../presensi.php?page=pp" target="framecenter">
      <font size="1" color="#000000"><b>Presence</b></font></a>&nbsp;>&nbsp;
        <font size="1" color="#000000"><b>Presence Statistic for each Students</b></font>
        </td>     
    </tr>
	</table>
    </td>
