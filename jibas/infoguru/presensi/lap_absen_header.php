...
<tr>
	...
	<td width="*" rowspan="4" align="left" valign="middle"><a href="#" onclick="tampil()" ><img src="../images/ico/view.png" onmouseover="showhint('Click to show not attend student daily data reports', this, event, '180px')" height="48" width="48" border="0" name="tabel" id="tabel2"/></a></td>
        <td width="*" rowspan="3" align="right" valign="top">
         <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Absent Student Data Report Card</font><br />
    <a href="../presensi.php?page=pp" target="framecenter">
      <font size="1" color="#000000"><b>Presence</b></font></a>&nbsp;>&nbsp;
        <font size="1" color="#000000"><b>Absent Student Data Report Card</b></font>
        </td>   
    </td>
</tr>
