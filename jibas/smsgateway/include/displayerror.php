...
if ($_SESSION['errno'] != 0) 
{
	...
	{
		$errstr  = "<br><br><br><br><br><br><font family='arial' color='red' size='3' style='text-decoration:none'><strong>Sorry, you should not delete this data now because it is being used</strong></font><br><br>";
	} 
	else 
	{	
		$errstr  = "<center><h2>Sorry, there is an error</h2></center>\n";
      ...
      // errno 1146 : Table '%s.%s' doesn't exist 
		...
		{
			$errstr .= "<center>
							There is an error on the database installation or configuration. Please check them back.
		...
		if ($_SESSION['issend'])
		{
	      $errstr .= "<p align='center'>
							...
							If the problem still exists, send a report to <a style='color:blue; text-decoration:underline;' target='_blank' href='http://support.jibas.net'>JIBAS Support Center</a></p>\n";
		}
