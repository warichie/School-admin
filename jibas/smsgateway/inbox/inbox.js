...
$(".btnView").live('click',function(e){
	...
	dialog.dialog({title:'Message Details',modal:true,show:'fade',hide:'fade',width:'300px',position:'top',
		open:function(){
...
$(".periode").live('change',function(e){
	e.preventDefault;
	var y = $("#year").val();
	var m = $("#month").val();
	$.ajax({
		url : 'inbox.class.php',
		data: 'cmd=getList&y='+y+"&m="+m,
		success:function(out){
