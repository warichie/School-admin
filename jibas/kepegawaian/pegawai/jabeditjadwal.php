...
<title>Edit Promotion Schedule</title>
...
function validate()
{
	return validateEmptyText('txThn', 'Date Jadwal Kenaikan Position Pegawai') && 
  		   validateInteger('txThn', 'Month Jadwal Kenaikan Position Pegawai') && 
		   validateLength('txThn', 'Year Jadwal Kenaikan Position Pegawai', 4) &&
		   validateEmptyText('txKeterangan', 'Schedule Info Kenaikan Position Pegawai');
}
...
<tr height="30">
	<td width="100%" class="header" align="center">Edit Promotion Schedule</td>
</tr>
<tr>
	...
	<tr>
        <td align="right" valign="top"><strong>Promotion Schedule :</strong></td>
