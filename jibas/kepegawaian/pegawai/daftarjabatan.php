...
<?	} // while 
	...
	<tr height="80">
    	<td colspan="4" align="center" valign="middle">
            ...
            <font color="#999999"><strong>This employee has no promotion schedule yet.<br />Click <input type="button" name="btTambah" value="here" class="but" style="color:#003399" onclick="JavaScript:TambahJ()" /> untuk mengisi jadwal kenaikan jabatan</strong></font>
