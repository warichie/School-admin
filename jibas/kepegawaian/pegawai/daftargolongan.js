function TambahJ()
{
	...
	var addr = "goladdjadwal.php?nip="+nip;
    newWindow(addr, 'TambahJadwalGolongan','480','250','resizable=1,scrollbars=1,status=0,toolbar=0');
}

function UbahJ(id)
{
	var addr = "goleditjadwal.php?id="+id;
    newWindow(addr, 'UbahJadwalGolongan','480','250','resizable=1,scrollbars=1,status=0,toolbar=0');
}
