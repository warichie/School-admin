...
<?	} // while 
	...
	<tr height="80">
    	<td colspan="4" align="center" valign="middle">
            ...
            <font color="#999999">
			<strong>This employee has no promotion schedule yet.<br />
			Click <input type="button" name="btTambah" value="here" class="but" style="color:#003399" onclick="JavaScript:TambahJ()" /> to add promotion schedule</strong></font>
...
<tr height="30">
	<td width="5%" align="center" class="header">#</td>
    <td width="10%" align="center" class="header">Level</td>
