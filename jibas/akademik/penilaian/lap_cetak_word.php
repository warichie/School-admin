...
<?		for($i = 0; $i < count($aspekarr); $i++)
	...
	<tr>
<?	for($i = 0; $i < count($aspekarr); $i++)
		echo "<td class='header' align='center' width='7%' bgcolor='#CCCCCC'><strong>Number</strong></td>
			  <td class='header' align='center' width='7%' bgcolor='#CCCCCC'><strong>Letter</strong></td>
			  <td class='header' align='center' width='20%' bgcolor='#CCCCCC'><strong>Spelled Out</strong></td>"; ?>   
   </tr>
