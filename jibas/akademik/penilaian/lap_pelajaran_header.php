...
<table width="100%" border="0" >
 <tr>
    ...
    <td width="32%" rowspan="2" valign="bottom"><a href="JavaScript:carisiswa()" onmouseover="showhint('Search Student', this, event, '50px')"><img src="../images/ico/lihat.png" border="0"/></a></td>
 </tr>
<tr>
