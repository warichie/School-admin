...
<table width="100%"> 
    ...
    <tr>
		...
		<td align="right">
      <!--<a  href="#" onClick="newWindow('cetak_detail_pegawai.php?replid=<?=$replid?>', 'DetailPegawai','820','700','resizable=1,scrollbars=1,status=0,toolbar=0')"><img src="../images/ico/print.png" border="0"/>&nbsp;Print</a>&nbsp;&nbsp;-->
      	<a  href="#" onClick="newWindow('pegawai_cetak_detail.php?replid=<?=$replid?>', 'DetailPegawai','790','650','resizable=1,scrollbars=1,status=0,toolbar=0')"><img src="../images/ico/print.png" border="0"/>&nbsp;Print</a>&nbsp;&nbsp;
      	<a href="#" onclick="window.close();"><img src="../images/ico/exit.png" width="16" height="16" border="0" />&nbsp;Close</a></td>
	</tr>
</table>
<br />
