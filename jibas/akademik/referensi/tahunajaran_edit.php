...
if (isset($_REQUEST['Simpan'])) {
	...
	if (mysql_num_rows($result) > 0) {
		CloseDb();
			$ERROR_MSG = "Year of Teaching $_REQUEST[tahunajaran] has been used";
	} else {
...
<title>JIBAS SIMAKA [Edit Year of Teaching]</title>
...
<tr>
    ...
    <td colspan="2">
    	<input type="text" name="tahunajaran" id="tahunajaran" size="30" maxlength="50" value="<?=$tahunajaran ?>" onFocus="showhint('Name Year of Teaching should not exceed 50 characters', this, event, '120px')"   onKeyPress="return focusNext('keterangan', event)"/>
    </td>
</tr>
<tr>
