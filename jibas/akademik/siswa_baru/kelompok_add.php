...
if (isset($_REQUEST['Simpan'])) {
	...
	if (mysql_num_rows($result) > 0) {
		$ERROR_MSG = "Name ".$kelompok." has been used";
		CloseDb();
	} else {
...
<title>JIBAS SIMAKA [Add Student Candidate Group]</title>
...
<tr>
	<td width="120"><strong>Admission</strong></td>
