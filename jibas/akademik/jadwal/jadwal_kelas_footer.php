    ...
    <table width="100%" border="0" align="center">
  	<tr>
   	...
   	<? if (SI_USER_LEVEL() != $SI_USER_STAFF) { ?>
	    <a title="Delete" href="JavaScript:hapus(<?=$kelas ?>, 1)">
        <img src="../images/ico/hapus.png" border="0" onMouseOver="showhint('Delete Schedule', this, event, '90px')"/>&nbsp;Hapus Class Schedule Ini</a>&nbsp;&nbsp;
	<? } ?>  
