...
<tr>
    ...
    <tr>
    	<td align="left"><strong>Admission Process</strong></td>    
	 	...
	 	<option value="-1" >(All Graduation)</option>	
		<?
      		OpenDb();
    ...
    <tr>
   	...
   	<td width="5%" rowspan="2" valign="middle"><a href="#" onclick="tampil_statistik()" ><img src="../images/view.png" height="48" border="0" name="tabel" id="tabel" onmouseover="showhint('Click to show statistik ', this, event, '120px')"/></a></td>
    <td width="50%" align="right" valign="top"><font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Student Statistic</font><br />
    <a href="../siswa.php" target="content">
      	<font size="1" color="#000000"><b>Student</b></font></a>&nbsp;>&nbsp; 
        <font size="1" color="#000000"><b>Student Statistic.</b></font>
    </td>    
</tr>
</table>
</td>
