...
<tr>
  <td align="left" valign="top">
    ...
    <tr>
        <td align="right"> <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Alumni List</font>
        </td>
   	</tr>
    <tr>
        <td align="right"><a href="../kelulusan.php" target="content"> 
        <font size="1" color="#000000"><b>Grade Promotion and Graduation</b></font></a>&nbsp;>&nbsp;
        <font size="1" color="#000000"><b>Alumni List</b></font></td>
    </tr>
    <tr>
      <td align="left">&nbsp;</td>
      </tr>
...
if ($jum_tahun > 0){
	...
	<?	if (SI_USER_LEVEL() != $SI_USER_STAFF) { ?>
	    <a href="JavaScript:tambah()"><img src="../images/ico/tambah.png" border="0" onMouseOver="showhint('Add', this, event, '50px')" />&nbsp;Add Alumni</a>
	<?	 } ?></td>
    </tr>
    </table>
    <br />
    ...
    <tr height="30" class="header" align="center">
        ...
        <td width="10%" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" style="cursor:pointer;" onClick="change_urut('a.angkatan','<?=$urutan?>')"> Graduates <?=change_urut('a.angkatan',$urut,$urutan)?></td>
        ...
        <td width="15%" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" style="cursor:pointer;" onClick="change_urut('t.tingkat, k.kelas','<?=$urutan?>')">Last Class <?=change_urut('t.tingkat, k.kelas',$urut,$urutan)?></td>
		<td width="15%" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" style="cursor:pointer;" onClick="change_urut('al.tgllulus','<?=$urutan?>')">Date Graduated <?=change_urut('al.tgllulus',$urut,$urutan)?></td>
        <td width="10%">&nbsp;</td>
    </tr>
	<? 	
		if ($page==0)
    ...
    <tr height="25">
        ...
        <td align="center"><a href="#" onClick="newWindow('../library/detail_siswa.php?replid=<?=$row['replidsiswa']?>', 'DetailSiswa','800','650','resizable=1,scrollbars=1,status=0,toolbar=0')"><img src="../images/ico/lihat.png" width="16" height="16" border="0" onMouseOver="showhint('Alumni Data Details', this, event, '80px')"/></a>&nbsp;
<?		if (SI_USER_LEVEL() != $SI_USER_STAFF) {  ?> 
			<a href="#" onClick="newWindow('siswa_cetak_detail.php?replid=<?=$row['replidsiswa']?>', 'DetailSiswa','800','650','resizable=1,scrollbars=1,status=0,toolbar=0')"><img src="../images/ico/print.png" border="0" onMouseOver="showhint('Print Alumni Data Details', this, event, '100px')"/></a>&nbsp;
