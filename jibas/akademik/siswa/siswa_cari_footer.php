...
?>
	...
	<tr>
        ...
        <a href="#" onclick="excel('<?=$urut?>','<?=$urutan?>')" ><img src="../images/ico/excel.png" border="0" onMouseOver="showhint('Excel', this, event, '80px')" />&nbsp;Excel</a>&nbsp;&nbsp;
        <a href="#" onclick="cetak('<?=$urut?>','<?=$urutan?>')" ><img src="../images/ico/print.png" border="0" onMouseOver="showhint('Print', this, event, '50px')"/>&nbsp;Print</a>
        </td>
    </tr>
    </table>
    <br />
    ...
    <!-- TABLE CONTENT -->
 	<tr height="30" class="header" align="center">
		...
		<td width="15%" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" style="cursor:pointer;" onClick="change_urutan('nisn','<?=$urutan?>')" >National Student ID <?=change_urut('nisn',$urut,$urutan)?></td>
        ...
        <td width="20%" background="../style/formbg2.gif">Birth Place</td>
        <td width="8%" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" style="cursor:pointer;" onClick="change_urutan('tingkat','<?=$urutan?>')" >Grade <?=change_urut('tingkat',$urut,$urutan)?></td>
        <td width="8%" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" style="cursor:pointer;" onClick="change_urutan('kelas','<?=$urutan?>')">Class <?=change_urut('kelas',$urut,$urutan)?></td>
	...
	?>
  	<tr height="25"> 
        ...
        <img src="../images/ico/lihat.png" border="0" onmouseover="showhint('See Details', this, event, '50px')" /></a></td>
  	</tr>
  	<?		$cnt_siswa++;
		}
		CloseDb();
