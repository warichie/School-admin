...
<br /><left>
  <div align="right"><span class="style1"><a href="#" onClick="document.location.reload()"><img src="../images/ico/refresh.png" border="0" />&nbsp;Refresh</a>&nbsp;&nbsp;
    <a  href="#" onClick="newWindow('siswa_cetak_detail.php?nis=<?=$nis?>', 'DetailSiswa','782','864','resizable=1,scrollbars=1,status=0,toolbar=0')"><img src="../images/ico/print.png" border="0" />Print</a>&nbsp;&nbsp;</span><br />
   </div>
</left>
...
<table width="100%" border="0" cellspacing="5">
  ...
  <tr>
    ...
    <td colspan="4" class="header"><strong>PERSONAL INFO</strong></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td width="3%" >1.</td>
  ...
  <tr>
    ...
    <td  colspan="4" class="header"><strong>RESIDENCY INFO</strong></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>12.</td>
  ...
  <tr>
    ...
    <td class="header" colspan="4"><strong>HEALTH INFO</strong></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>16.</td>
  ...
  <tr>
    ...
    <td class="header" colspan="4"><strong>PAST EDUCATION INFO</strong></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>20.</td>
  ...
  <tr>
    ...
    <td class="header" colspan="4"><strong>PARENT INFO</strong></td>
    </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<table width="100%">
<tr>
<td align="right"><input type="button"  name="tutup" id="tutup" value="Close" class="but"  onclick="tutup()"/>
</td>
</tr>
</table>
<script language='JavaScript'>
