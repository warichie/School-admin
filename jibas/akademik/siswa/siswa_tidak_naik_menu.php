...
function tampil_siswa() {
	...
	if (tingkat.length<1){
		alert ('No grade according to Year of Teaching and Department');
		return false;
		}
...
<form name="menu" id="menu">
    ...
    <table width="100%" border="0" cellspacing="0">
   	<tr  <? if ($pilihan=="2") { ?> style="background-color:#C0C0C0" <? } ?>>
        ...
        <td width="50"><input type="button" class="but" name="lihat" id="lihat" value="Show" onclick="lihat_siswa()" style="width:70px;" onMouseOver="showhint('Sort by Class', this, event, '135px')"/></td>
	</tr>
    <tr  <? if ($pilihan=="1") { ?> style="background-color:#C0C0C0" <? } ?>>
        <td align="center" valign="middle">
        <img src="../images/ico/titik.png" height="5" width="5" align="top"></td>
        <td>Search</td>
        <td><strong>Student ID</strong>&nbsp;<input type="text" name="nis" id="nis" size="15" value="<?=$nis?>"onkeypress="return focusNext('cari', event)"/>&nbsp;
        <strong>Name</strong>&nbsp;<input type="text" name="nama" id="nama" size="10" value="<?=$nama?>" onkeypress="return focusNext('cari', event)" /></td>
        <td><input type="button" class="but" name="cari" id="cari" value="Search" onclick="cari_siswa();" style="width:70px;" onmouseover="showhint('Sort by Search', this, event, '150px')"/></td>
  	</tr>
    <tr <? if ($pilihan=="3") { ?> style="background-color:#C0C0C0" <? } ?>>
        <td align="center" valign="middle">
        <img src="../images/ico/titik.png" height="5" width="5" align="top"></td>
        <td colspan="2">All active student</td>
