...
if (isset($_POST['simpan'])) {
	...
	if (mysql_num_rows($hasil) > 0) {
		CloseDb();
		$ERROR_MSG = "Conditions $kondisi has been used";
...
<title>JIBAS SIMAKA [Add New Condition]</title>
<script language="javascript">
function cek() {
	var kondisi = document.main.kondisi.value;
	var urutan = document.main.urutan.value;
	if (kondisi.length == 0) {
		alert('You have not enter Condition Name yet yet');
...
<tr height="150">
   ...
   <table border="0" width="95%" cellpadding="2" cellspacing="2" align="center">
    ...
    <tr>
        ...
        <td><input name="urutan" id="urutan" maxlength="2" size="2" onFocus="showhint('Urutan tampil Conditions', this, event, '120px');panggil('urutan')" value="<?=$urutan?>" onKeyPress="return focusNext('Simpan', event)"></td>
    </tr>
    <tr>        
