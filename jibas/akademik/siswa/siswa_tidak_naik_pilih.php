...
function pindah_siswa(nis,idkelas, i) {
	...
	if (confirm("Are you sure want to place this student stay in class and get no grade promotion?")){
...
<tr>
	...
	<tr align="center">
    	<td width="6%" rowspan="2" class="header" height="30">#</td>
		...
		<td width="14%" height="30" rowspan="2" class="header" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" style="cursor:pointer;" onClick="change_urutan('k.kelas','<?=$urutan?>')"><div align="center">Class <?=change_urut('k.kelas',$urut,$urutan)?></td>
		<td height="15" colspan="2" class="header">Fail a Grade</td>
    </tr>
    <tr>
    	<td width="26%" class="header">Info</td>
...
?>
    ...
    <tr height="25">
    	...
    	<td align="center"><input type="button" class="but" value=" > " onClick="pindah_siswa('<?=$row_siswa[0]?>', '<?=$row_siswa[2]?>', <?=$cnt?>)" onMouseOver="showhint('Click to fail a grade', this, event, '80px')"/></td>
    </tr>
<?			$cnt++;
		}
...
?>
	...
	<tr>
      ...
      show a list of failed grade student</b></font>
 	</td>
	</tr>
	</table>
<? 	} ?>
