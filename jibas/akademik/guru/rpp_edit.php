...
<tr>
	...
	<td>
    	<input type="text" name="kode" id="kode" size="10" maxlength="20" value="<?=$kode?>" onFocus="showhint('Lesson Code should not exceed 20 characters', this, event, '120px');panggil('kode')"  onKeyPress="return focusNext('materi', event)"/>    </td>
