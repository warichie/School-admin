...
<title>Class Subject List</title>
...
function setaktif(replid, aktif) {
	...
	if (aktif == 1) {
		msg = "Are you sure want to change this Class Subject List to INACTIVE?";
		newaktif = 0;
	} else	{	
		msg = "Are you sure want to change this Class Subject List to ACTIVE?";
		newaktif = 1;
	}
...
function hapus(replid) {
	...
	var urut = document.getElementById('urut').value;
	var urutan = document.getElementById('urutan').value;
	if (confirm("Are you sure want to delete this Class Subject List?"))
...
<tr>
  <td align="left" valign="top">
    ...
    <!-- TABLE TITLE -->
    <tr>
        <td align="right"><font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Class Subject List</font></td>
        </tr>
    <tr>
        <td align="right"><a href="../guru.php?page=p" target="content">
          <font size="1" color="#000000"><b>Teacher and Class Subject</b></font></a>&nbsp;>&nbsp; <font size="1" color="#000000"><b>Class Subject</b></font></td>
        </tr>
    <tr>
      <td align="left">&nbsp;</td>
      </tr>
...
<?	//if (SI_USER_LEVEL() != $SI_USER_STAFF) { ?>
	    <a href="JavaScript:tambah()"><img src="../images/ico/tambah.png" border="0" onMouseOver="showhint('Add', this, event, '50px')"/>&nbsp;Add Class Subject</a>
<?	//} ?>    
    </td></tr>
    </table><br />
    ...
    <tr height="30" align="center" class="header">
    	<td width="4%">#</td>
        <td width="8%" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" style="cursor:pointer;" onClick="change_urut('kode','<?=$urutan?>')">Code <?=change_urut('kode',$urut,$urutan)?></td>
        <td width="25%" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" style="cursor:pointer;" onClick="change_urut('nama','<?=$urutan?>')">Name <?=change_urut('nama',$urut,$urutan)?></td>
        <td width="10%" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" style="cursor:pointer;" onClick="change_urut('sifat','<?=$urutan?>')">Characteristic <?=change_urut('sifat',$urut,$urutan)?></td>
        <td width="*" >Info</td> 
...
<?			} //end if
        ...
        <td align="center">
            <a href="JavaScript:edit(<?=$row['replid'] ?>)"><img src="../images/ico/ubah.png" border="0" onMouseOver="showhint('Edit Class Subject', this, event, '60px')" /></a>&nbsp;
<?		if (SI_USER_LEVEL() != $SI_USER_STAFF) {  ?>
            <a href="JavaScript:hapus(<?=$row['replid'] ?>)"><img src="../images/ico/hapus.png" border="0" onMouseOver="showhint('Delete', this, event, '60px')" /></a>
        </td>
<?		} ?> 
    </tr>
<?	} 
