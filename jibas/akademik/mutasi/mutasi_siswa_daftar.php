...
<tr>
    ...
    <tr height="30" class="header" align="center">
    	<td width="6%">#</td>
    	<td width="20%" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" style="cursor:pointer;" onClick="change_urutan('s.nis','<?=$urutan?>')" >Student ID <?=change_urut('s.nis',$urut,$urutan)?></td> 
    	...
    	<td width="20%" onMouseOver="background='../style/formbg2agreen.gif';height=30;" onMouseOut="background='../style/formbg2.gif';height=30;" background="../style/formbg2.gif" style="cursor:pointer;" onClick="change_urutan('s.idkelas','<?=$urutan?>')" >Class <?=change_urut('s.idkelas',$urut,$urutan)?></td> 
    	<td width="10%"></td>
  	</tr>
...
?>
  	<tr height="25"> 
    	...
    	<td align="center"><input type="button" value=">" class="but" onClick="mulai_pindah('<?=$nis?>')" onMouseOver="showhint('Click for Mutation', this, event, '80px')"/></td>
  	</tr>
<?
...
?>
	...
	<tr>
      ...
      to show Student Mutation List.</b></font>
 	</td>
	</tr>
	</table>
<? 	} ?>
