...
<tr>
    ...
    <td rowspan="2" align="left" valign="middle" width="*"><a href="#" onclick="tampil()"><img src="../images/view.png" onmouseover="showhint('Click to show this student presence report', this, event, '150px')" height="48" border="0" name="tabel" id="tabel2"/></a></td>
