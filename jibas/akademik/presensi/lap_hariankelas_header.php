...
<tr>	
    ...
    <td width="*" rowspan="3" align="left" valign="middle"><a href="#" onclick="tampil()" ><img src="../images/view.png" onmouseover="showhint('Click to show laporan presensi harian per kelas', this, event, '100px')" height="48" width="48" border="0" name="tabel" id="tabel"/></a></td>
