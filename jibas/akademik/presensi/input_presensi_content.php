...
<tr>
    ...
    <table border="1" width="100%" id="table" class="tab" bordercolor="#000000">
		<tr height="15">		
			<td width="3%" align="center" class="headerlong" rowspan="2">#</td>
			<td width="8%" align="center" class="headerlong" rowspan="2">Student ID</td>
			<td width="*" align="center" class="headerlong" rowspan="2">Name</td>
            ...
            <td width="21%" align="center" class="headerlong" rowspan="2">Info</td>
		</tr>
        <tr height="15">       	          
