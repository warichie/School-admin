...
<tr>
	...
	<td rowspan="3" align="left" valign="middle"><a href="#" onclick="tampil()" ><img src="../images/view.png" onmouseover="showhint('Click to show daily presence statistic for each classes', this, event, '160px')" height="48" width="48" border="0" name="tabel" id="tabel2"/></a></td>
