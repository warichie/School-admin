...
<table width="100%" border="0" cellspacing="0">
  <tr>
    <th scope="row" colspan="10"><span class="style1">Teacher Presence Report</span></th>
  </tr>
</table>
<br />
<table width="27%">
...
<tr>
	<td width="43%"><span class="style4">Teacher</span></td>
    <td width="57%" colspan="10"><span class="style4">: <?=$nip.' - '.$row['nama']?></span></td>
</tr>
<tr>
	<td width="120"><span class="style4">Department</span></td>
    <td colspan="10"><span class="style4">: <?=$row['departemen']?></span></td>
</tr>
<tr>
	<td width="120"><span class="style4">Year</span></td>
    <td colspan="10"><span class="style4">: <?=$row['tahunajaran']?></span></td>
</tr>

<tr>
	<td><span class="style4">Period</span></td>
    <td colspan="10"><span class="style4">: <?=format_tgl($tglawal).' to '. format_tgl($tglakhir) ?></span></td>
</tr>
</table>
<br />
<? 		
...
<?		
    ...
    <tr height="25" valign="middle">    	
        ...
        <td align="center"><span class="style7"><?=$row[7]?> minutes</span></td>
