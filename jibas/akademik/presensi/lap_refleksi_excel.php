...
<table width="100%" border="0" cellspacing="0">
  <tr>
    <th scope="row" colspan="7"><span class="style1">Teaching Reflection Report</span></th>
  </tr>
</table>
<br />
<table width="27%">
...
<tr>
	<td><span class="style4">Year</strong></td>
...
<tr>
	<td><span class="style4">Grade</strong></td>
    <td colspan="7"><span class="style4">: <? if ($tingkat == -1) echo "All Tingkat"; else echo $row['tingkat']; ?></strong></td>
</tr>
<tr>
	<td><span class="style4">Class</strong></td>
    <td colspan="7"><span class="style4">: <? if ($kelas == -1) echo "All Classes"; else echo $row['kelas']; ?></strong></td>
</tr>
<tr>
	<td><span class="style4">Class Subject</strong></td>
    <td colspan="7"><span class="style4">: <? if ($pelajaran == -1) echo "All Class Subject"; else echo $row['nama']; ?></strong></td>
</tr>
<tr>
	<td><span class="style4">Period</strong></td>
    <td colspan="7"><span class="style4">: <?=format_tgl($tglawal).' to '. format_tgl($tglakhir) ?></strong></td>
</tr>
</table>
<br />
<? 		
