...
<?	} ?>
    ...
    <td width="*" rowspan="4" align="left" valign="middle"><a href="#" onClick="show()" ><img src="../images/view.png" onMouseOver="showhint('Click to show presensi berdasarkan pelajaran', this, event, '150px')" name="tabel" width="48" height="48" border="0" id="tabel2"/></a></td>
