...
<tr>	
	...
	<tr>
    	<td width="20%"><strong>Teacher</strong></td>
        <td colspan="4"><strong>
    ...
    <td width="*" align="left" valign="middle"><a href="#" onclick="tampil()" ><img src="../images/view.png" onmouseover="showhint('Click to show Teacher Presence reports', this, event, '180px')" height="48" width="48" border="0" name="tabel" id="tabel2"/></a></td>
