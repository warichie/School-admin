...
<tr>	
	...
	<td align="left" valign="middle"><a href="#" onclick="tampil()" ><img src="../images/view.png"  onmouseover="showhint('Click to show Presence Statistic for each students', this, event, '100px')" height="48" border="0" name="tabel" id="tabel"/></a></td>
