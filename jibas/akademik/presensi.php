...
<div id="content" align="left">
        ...
        <td>
            ...
            <tr>
                ...
                <td rowspan="3">
                    <a href="presensi/presensi_main.php" onMouseOver="showhint('Presence Data for each Classes Subject', this, event, '100px')"><img src="images/pres_pelajaran_08.jpg" alt="" width="130" height="126" border="0"></a></td>
          <td rowspan="3">
        ...
        <table width="100%" border="0" id="slice_ph" style="display:none">
          ...
          <td rowspan="3">
            ...
            <tr>
                ...
                <td rowspan="2" valign="middle"><a href="presensi/lap_hariansiswa_main.php" onMouseOver="showhint('Daily Presence for each Students', this, event, '100px')">Reports
                    Daily Presence Student</a><br>
                  <a href="presensi/lap_hariankelas_main.php" onMouseOver="showhint('Daily Presence Report for each Classes', this, event, '100px')">Reports
                  Daily Presence per Class</a><br>
                  <a href="presensi/lap_harianabsen_main.php" onMouseOver="showhint('Student Daily Presence Reports Yang Absent', this, event, '100px')">Reports
                  Harian Student Data yang Absent</a></td>
          <td>
