...
<title>JIBAS SIMAKA [Edit Lesson Plans]</title>
...
<!-- TABLE CONTENT -->
<tr height="25">
<td class="header" colspan="2" align="center">Edit Lesson Plans</td>
</tr>
<tr>
...
<tr>
	...
	<td><input type="text" name="materi" id="materi" size="83" maxlength="225" value="<?=$materi?>" onFocus="showhint('Subject Matter should not exceed 20 characters', this, event, '120px')"  onKeyPress="return focusNext('deskripsi', event)"/>
