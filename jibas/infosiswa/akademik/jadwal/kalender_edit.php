...
<html>
<head>
<title>JIBAS SIMAKA [Edit Academic Calendar]</title>
...
function validate() {
	return validateEmptyText('kalender', 'Academic Calendar'); 
}
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" style="background-color:#FFFFFF" onLoad="document.getElementById('kalender').focus();">
...
<tr height="150">
    ...
    <!-- TABLE CONTENT -->
    <tr height="25">
      	<td colspan="2" class="header" align="center">Edit Academic Calendar</td>
    </tr>
    <tr>
