...
if (isset($_REQUEST['Simpan'])) {	
	...
	if (mysql_num_rows($result_simpan_cek) > 0) {
		CloseDb();
		$ERROR_MSG = $deskripsi." has been used";
	} else {
...
<html>
<head>
<title>JIBAS SIMAKA [Edit Schedule Info]</title>
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" style="background-color:#FFFFFF" onLoad="document.getElementById('deskripsi').focus();">
...
<tr height="150">
    ...
    <!-- TABLE CONTENT -->
    <tr height="25">
      	<td colspan="2" class="header" align="center">Edit Schedule Info</td>
    </tr>
    <tr>
