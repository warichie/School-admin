...
<tr>
   ...
   <tr>
    ...
    <td valign="middle" rowspan="2" width="10%" align="left" ><a href="#" onClick="tampil()"><img src="../images/ico/view.png" height="48" width="48" border="0" name="tabel" id="tabel"  onmouseover="showhint('Click to show Academic Calendar', this, event, '120px')"/></a></td>
	<td valign="top" align="right" width="35%">
		<font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Academic Calendar</font>   	
	</td>
</tr>
</table>
