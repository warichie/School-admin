...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr>
    <th width="8%" align="right" scope="row">Title</th>
    <td colspan="2"><input type="text" name="judul" id="judul" size="50" maxlength="254" /></td>
  </tr>
  <tr>
    <th align="right" scope="row">Date</th>
  ...
  <tr>
    <th align="right" valign="top" scope="row">Abstract</th>
    <td colspan="2"><textarea name="abstrak" id="abstrak" cols="100"></textarea></td>
  </tr>
  <tr>
    <th align="right" valign="top" scope="row">Class Subject</th>
