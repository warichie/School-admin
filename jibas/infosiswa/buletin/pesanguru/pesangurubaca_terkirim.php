...
$sql2="SELECT DATE_FORMAT(pg.tanggalpesan, '%Y-%m-%j') as tanggal, pg.judul as judul, pg.pesan as pesan, p.nama as nama FROM jbsvcr.pesan pg, jbsakad.siswa p WHERE pg.nis=p.nis AND pg.replid='$replid'";
