...
if ($op=="f3fxxa7svys774l3067den747hhd783uu83"){//Mindahin ke draft
	...
	while ($x<=$numdel){
		...
		//echo $sql."<br>";
		$sql2="SELECT replid,tanggalpesan,judul,pesan,idguru FROM jbsvcr.pesan WHERE replid='$row[idpesan]'";
		$result2=QueryDb($sql2);
		$row2=@mysql_fetch_array($result2);
		//echo $sql2."<br>";
		$sql3="INSERT INTO jbsvcr.draft SET tanggalpesan='$row2[tanggalpesan]',judul='$row2[judul]',pesan='$row2[pesan]',idpemilik='".SI_USER_ID()."',idpengirim='$row2[idguru]'";
...
<table width="100%" border="0" cellspacing="0">
  ...
  <tr <?=$tr?> >
    ...
    <td height="25"><?=$depan?><? if ($row1['baru']==1) { ?><img title="Not Read" src="../../images/ico/unread.png" /><? } else { ?><img src="../../images/ico/readen.png" title="Read" /><? } ?><a href="#" onClick="bacapesan('<?=$row1['replid']?>')">
	<? 
  ...
  $cnt++;
   ...
   <tr>
    <td scope="row" colspan="8"><div align="center">No teacher message in your Inbox.</div></th>   </tr>
  <? } ?>
</table>
	</td>
  </tr>
