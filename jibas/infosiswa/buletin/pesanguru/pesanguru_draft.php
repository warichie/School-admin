...
function bacapesan(replid){
	document.location.href="pesangurubaca_draft.php?replid="+replid;
}
...
<body >
<form name="inbox" id="inbox"  action="pesanguru_draft.php">
<div align="right">
...
<table width="100%" border="0" cellspacing="0">
  ...
  $sql1="SELECT d.replid as replid,d.judul as judul, d.pesan as pesan, d.idpengirim as nip, p.nama as nama,DATE_FORMAT(d.tanggalpesan, '%e %b %Y') as tanggal, TIME_FORMAT(d.tanggalpesan, '%H:%i') as waktu FROM jbsvcr.draft d, jbssdm.pegawai p WHERE d.idpengirim=p.nip AND d.idpemilik='".SI_USER_ID()."' ORDER BY replid LIMIT ".(int)$page*(int)$varbaris.",$varbaris";
