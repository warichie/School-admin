...
<html>
	...
	<body style="background-image:url(../../images/bg1.jpg); height:565px; width:626px;" onLoad="document.getElementById('chatmsg').focus();" leftmargin="0" topmargin="0">
...
--><br></td>
  ...
  <tr>
    ...
    <td height="30" bgcolor="#FFFFFF">&nbsp;<img title="Angel" style="cursor:pointer;" onClick="accept_smiley('1')" src="smileys/angel.gif" width="15" height="15"  />&nbsp;<img title="Angry" style="cursor:pointer;" onClick="accept_smiley('2')" src="smileys/angry.gif"  width="15" height="15"/>&nbsp;<img title="Cool" style="cursor:pointer;" onClick="accept_smiley('3')" src="smileys/cool.gif" width="15" height="15" />&nbsp;<img title="Cry" style="cursor:pointer;" onClick="accept_smiley('4')" src="smileys/cry.gif" width="15" height="15" />&nbsp;<img title="Embrassed" style="cursor:pointer;" onClick="accept_smiley('5')" src="smileys/embrassed.gif" width="15" height="15" />&nbsp;<img title="Grin" style="cursor:pointer;" onClick="accept_smiley('6')" src="smileys/grin.gif" width="15" height="15" />&nbsp;<img title="Rolleyes" style="cursor:pointer;" onClick="accept_smiley('7')" src="smileys/rolleyes.gif" width="15" height="15" />&nbsp;<img title="Sad" style="cursor:pointer;" onClick="accept_smiley('8')" src="smileys/sad.gif" width="15" height="15" />&nbsp;<img title="Sealed Lips" style="cursor:pointer;" onClick="accept_smiley('9')" src="smileys/sealedlips.gif" width="15" height="15" />&nbsp;<img title="Shocked" style="cursor:pointer;" onClick="accept_smiley('10')" src="smileys/shocked.gif" width="15" height="15" />&nbsp;<img title="Smile" style="cursor:pointer;" onClick="accept_smiley('11')" src="smileys/smile.gif" width="15" height="15" />&nbsp;<img title="Tongue" style="cursor:pointer;" onClick="accept_smiley('12')" src="smileys/tongue.gif" width="15" height="15" />&nbsp;<img title="Undecided" style="cursor:pointer;" onClick="accept_smiley('13')" src="smileys/undecided.gif" width="15" height="15" />&nbsp;<img title="Wink"  style="cursor:pointer;" onClick="accept_smiley('14')" src="smileys/wink.gif" width="15" height="15" /></td>
