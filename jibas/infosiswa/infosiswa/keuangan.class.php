...
class CK
{
	...
	public function ShowDepartemenComboBox()
	{
		...
		echo "Department: <select name='departemen' disabled class='cmbfrm' id='departemen' style='width:150px' onChange=\"ChangeKeuOption('departemen')\">";
	...
	public function ShowTahunBukuComboBox()
	{
		...
		echo "Fiscal Year: <select name='idtahunbuku' disabled class='cmbfrm' id='idtahunbuku' style='width:150px' onChange=\"ChangeKeuOption('tahunbuku')\">";
