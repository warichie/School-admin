...
if (isset($_REQUEST['Simpan'])) {
	...
	if (mysql_num_rows($result) > 0) {		
		CloseDb();
		$ERROR_MSG = "Category $kategori has been used";		
	} else {
...
<title>JIBAS TEACHERS INFO [Add Student Notes Category]</title>
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" style=" background-image:url(../images/bgpop.jpg); background-repeat:repeat-x" onLoad="document.getElementById('kategori').focus();">
<form name="main" id="main" action="catatankategori_add.php" onSubmit="return validate()">
<table border="0" width="95%" cellpadding="2" cellspacing="2" align="center">
<!-- TABLE CONTENT -->
<tr height="25">
<td class="header" colspan="2"><div align="center">Add Category Notes</div></td>
</tr>
<tr>
