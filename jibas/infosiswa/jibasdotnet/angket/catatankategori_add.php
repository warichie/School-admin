...
<title>JIBAS TEACHERS INFO [Add Category Notes]</title>
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" style="background-color:#FFFFFF" onLoad="document.getElementById('kategori').focus();">
<form name="main" id="main" action="catatankategori_add.php" onSubmit="return validate()">
<table border="0" width="95%" cellpadding="2" cellspacing="2" align="center">
<!-- TABLE CONTENT -->
<tr height="25">
<td class="header" colspan="2"><div align="center">Add Questionnaire Notes</div></td>
</tr>
<tr>
