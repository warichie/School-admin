          ...
          <tr>
                    ...
                    <td colspan="3">
                        <table width="100%" border="0" cellspacing="0">
                          <tr>
							...
							?>
							<td align="center" style="cursor:pointer;" onClick="document.location.href='view_profil_guru.php?replid=<?=$row_gr[replid]?>';"><img src="../library/gambar.php?replid=<?=$row_gr[replid]?>&table=jbsvcr.profil" width="50" height="50"><br><?=$row_pg[panggilan]?></td>
                            <?
							}
							?>
                          </tr>
                    ...
                    <td colspan="3">
                    	<table width="100%" border="0" cellspacing="0">
                          <tr>
							...
							?>
							<td align="center"><img style="cursor:pointer;" onClick="document.location.href='view_profil_siswa.php?replid=<?=$row_s[replid]?>';" src="../library/gambar.php?replid=<?=$row_s[replid]?>&table=jbsvcr.profil" width="50" height="50"><br><?=$row_pgs[panggilan]?></td>
                            <?
							}
							?>
                          </tr>
                  ...
                  <tr>
                    <td colspan="3">
                    		<table width="100%" border="0" cellspacing="0">
							  ...
							  ?>
							  <tr>
                                <td width="16%" valign="middle"><div align="center"><img src="../library/gambar.php?replid=<?=$row_ft_sender[replid]?>&table=jbsvcr.profil" width="50" height="50"><br>
            ...
            <td valign="top"><table width="100%" border="0" cellspacing="0">
			  ...
			  <tr><?		
					...
					?>
                <td width="25%"><div align="center"><a href="<?=$WEB_GALLERY_DIR_IG?>photos/<?=$row_foto[filename]?>" rel="lytebox[vacation]"  >
				<!--onClick="lihat_gambar('../library/gambar.php?replid=<?=$row_foto[replid]?>&table=jbsvcr.galerifoto')"--><img src="<?=$WEB_GALLERY_DIR_IG?>thumbnail/<?=$row_foto[filename]?>" width="80" style="cursor:pointer;"><br>
			  ...
			  <?
				while ($row_fot=@mysql_fetch_array($res_fot)){
					?>
                <td width="25%"><div align="center"><a href="<?=$WEB_GALLERY_DIR_IG?>photos/<?=$row_fot[filename]?>" rel="lytebox[vacation]"  ><img   src="<?=$WEB_GALLERY_DIR_IG?>thumbnail/<?=$row_fot[filename]?>" width="80" style="cursor:pointer;"><br>
