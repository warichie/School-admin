...
if (SI_USER_ID()=="")
	exit;
OpenDb();
$res=QueryDb("SELECT * FROM jbsvcr.profil WHERE nis='".SI_USER_ID()."'");
...
if ($ada>0){
OpenDb();
$sql="UPDATE jbsvcr.profil SET nis='".SI_USER_ID()."',nama='$_REQUEST[nama]',alamat='$_REQUEST[alamat]',".
...
*/	
$sql="INSERT INTO jbsvcr.profil SET nis='".SI_USER_ID()."',nama='$_REQUEST[nama]',alamat='$_REQUEST[alamat]',".
	 " telpon='$_REQUEST[telpon]', hp='$_REQUEST[hp]', email='$_REQUEST[email]',hobi='$_REQUEST[hobi]',".
...
function chg_page(){
	...
	document.location.href="profile2.php?page="+page;
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <table border="0" cellspacing="2" >
  ...
  <tr>
    ...
    <input name="alamat" id="alamat" type="text" value="<?=$row[alamat]?>" size="50" />
    </div></td>
  </tr>
  <tr>
