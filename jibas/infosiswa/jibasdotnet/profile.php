...
//
$res_prof=QueryDb("SELECT * FROM jbsvcr.profil WHERE nis='".SI_USER_ID()."'");
...
$res_kom=QueryDb("SELECT DATE_FORMAT(tanggal, '%Y-%m-%d') as tanggal,DATE_FORMAT(tanggal, '%H:%i:%s') as jam, komentar, nis, replid FROM jbsvcr.komentar WHERE owner='".SI_USER_ID()."' ORDER BY replid DESC LIMIT ".(int)$page*(int)$bariskomentar.",".$bariskomentar);
...
function del_karya(replid,opkarya){
	if (confirm('Are you sure want to delete this work?replid='+replid+' opkarya='+opkarya))
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td height="20" colspan="3" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="20" colspan="3" >&nbsp;</td>
  </tr>
  <tr>
    <td height="20" colspan="3" >&nbsp;&nbsp;
        <input name="ubah" type="button" class="but" style="width:100px;" value="Edit Profil" onClick="document.location.href='profile_edit.php';">
      <!--&nbsp;
      <input name="tema" type="button" class="header" style="width:100px;" value="Profile Theme">
      &nbsp;
      <input name="ngobrol" type="button" class="header" style="width:100px;" value="Chat">
      &nbsp;
      <input name="pesan" type="button" class="header" style="width:100px;" value="Send Message">--></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="background-image:url(../images_slice/bg_profil80_08.png); background-repeat:repeat;" valign="top"><table width="100%" border="0" cellspacing="0">
      <tr>
        <td width="305" valign="top"><table width="305" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="25" colspan="3">&nbsp;&nbsp;&nbsp;
                    <div align="center"><span class="style2">Student ID
                      <?=SI_USER_ID()?>
                    </span></div>
              <br></td>
          </tr>
          ...
          <tr>
            ...
            <td height="25" align="right" valign="top">&nbsp;<a href="#" onClick="document.location.href='viewallguru.php'"><em>View All <span class="style4">(
                          <?=$jumguru?>
              )</span> ...</em></a></td>
          </tr>
          <tr>
            <td colspan="3"><table width="100%" border="0" cellspacing="0">
              <tr>
                <?
							...
							?>
                <td align="center"><img src="../library/gambar.php?replid=<?=$row_gr[replid]?>&table=jbsvcr.profil" style="cursor:pointer;" onClick="document.location.href='view_profil_guru.php?replid=<?=$row_gr[replid]?>';" width="50"><br>
                          <?=$row_pg[panggilan]?></td>
                <?
							}
							?>
          ...
          <tr>
            ...
            <td height="25" valign="top">&nbsp;</td>
            <td height="25" align="right" valign="top">&nbsp;<a href="#" onClick="document.location.href='viewallsiswa.php'"><em>View All <span class="style4">(
                          <?=$jumsiswa?>
              )</span> ...</em></a></td>
          </tr>
          <tr>
            <td colspan="3"><table width="100%" border="0" cellspacing="0">
              <tr>
                <?
							...
							?>
                <td align="center"><img style="cursor:pointer;" onClick="document.location.href='view_profil_siswa.php?replid=<?=$row_s[replid]?>';" src="../library/gambar.php?replid=<?=$row_s[replid]?>&table=jbsvcr.profil" width="50" ><br>
                          <?=$row_pgs[panggilan]?></td>
                <?
							}
							?>
              </tr>
          ...
          <tr>
            <td colspan="3"><? if ($op=="komen"){ ?>
                    <input name="komentar" type="submit" class="but" value="Send Comment">
                    <? } else { ?>
                    <input style="visibility:hidden;" onClick="document.location.href='profile.php?op=komen'" name="komentar" type="button" class="but" value="Write Comment">
                    <? } ?>            </td>
          </tr>
          <tr>
            <td colspan="3"><table width="100%" border="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="84%" valign="top"><input type="hidden" name="sender" value="<?=SI_USER_ID()?>">
                          <?=SI_USER_NICKNAME()?></td>
              </tr>
              <tr>
              ...
              <? } else { 
							  ...
							  $res_ft_sender = QueryDb("SELECT * FROM jbsvcr.profil WHERE nis='$row_kom[nis]'");
              ...
              <tr>
                ...
                <td width="84%" valign="top"><span class="style7">
                  ...
                  <?=$row_kom[komentar]?>
                  <div align="right"><img title="Hapus komentar ini" style="cursor:pointer;" src="../images/ico/hapus.png" onClick="if (confirm('Are you sure want to delete komentar ini ?')) document.location.href='profile.php?op=hapuskomentar&replid=<?=$row_kom[replid]?>'"></div></td>
              </tr>
              <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0">
          ...
          <tr>
            ...
            <td height="25" valign="top">&nbsp;</td>
            <td height="25" valign="top">&nbsp;</td>
            <td height="25" align="right" valign="top">&nbsp;<a href="#" onClick="document.location.href='profile.php?opfoto=viewallphoto'"><em>View All <span class="style4">(
              <?=$jumfoto?>
              )</span> ...</em></a></td>
          </tr>
          <? 
          ...
          <tr>
            <?		
					$res_foto=QueryDb("SELECT * FROM jbsvcr.galerifoto WHERE nis='".SI_USER_ID()."' ORDER BY replid DESC LIMIT ".(int)$i*(int)$barisfoto.",".$barisfoto);
						while ($row_foto=@mysql_fetch_array($res_foto)){
					?>
            <td width="25%"><div align="center"> <a title="<?=$row_foto[keterangan]?>" href="<?=$WEB_GALLERY_DIR?>photos/<?=$row_foto[filename]?>" rel="lytebox[vacation]"  >
          ...
          <tr>
            <?
				while ($row_fot=@mysql_fetch_array($res_fot)){
					?>
            <td width="25%"><div align="center"><a title="<?=$row_foto[keterangan]?>" href="<?=$WEB_GALLERY_DIR?>photos/<?=$row_fot[filename]?>" rel="lytebox[vacation]"  ><img   src="<?=$WEB_GALLERY_DIR?>thumbnail/<?=$row_fot[filename]?>" width="80"  height="80 "style="cursor:pointer;"><br>
                      <?=$row_fot[keterangan]?>
            </a> </div></td>
            <? } ?>
          </tr>
          ...
          <tr>
            ...
            <td width="25%" height="25" valign="top">&nbsp;</td>
            <td height="25" align="right" valign="top">&nbsp;<a href="#" onClick="document.location.href='profile.php?opkarya=viewallkarya'"><em>View All <span class="style4">(
              <?=$jumkarya?>
              )</span> ...</em></a></td>
          </tr>
          <? 
          ...
          <tr>
            <?		
					...
					?>
            <td width="25%"><a style="text-decoration:none;" href="#" onClick="showkarya('<?=$row_karya[replid]?>')"> <em><font color="#006666" size="1" face="Verdana, Arial, Helvetica, sans-serif">
          ...
          <tr>
            <?
				while ($row_kar=@mysql_fetch_array($res_kar)){
					?>
            <td width="25%"><a style="text-decoration:none;" href="#" onClick="showkarya('<?=$row_kar[replid]?>')"> <em><font color="#006666" size="1" face="Verdana, Arial, Helvetica, sans-serif">
