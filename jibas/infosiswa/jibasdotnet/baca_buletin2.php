...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <!--td height="20" colspan="3" >&nbsp;&nbsp;<input name="ubah" type="button" class="header" style="width:100px;" value="My Profile" onClick="document.location.href='profile2.php';">&nbsp;<input name="tema" type="button" class="header" style="width:100px;" value="Profile Theme">&nbsp;<input name="ngobrol" type="button" class="header" style="width:100px;" value="Chat">&nbsp;<input name="pesan" type="button" class="header" style="width:100px;" value="Send Message"></td>
  </tr-->
  <tr>
