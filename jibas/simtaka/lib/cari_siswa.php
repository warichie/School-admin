...
<? } else { ?>    		
	...
	<font size = "2" color ="red"><b>Data Not Found. <br /><br />            
		Add student data in Student Data menu on Student section. </b></font>	
	<br /><br />   		</td>
    </tr>
    </table>
<? 	} 
...
<br /><br />	
<font size="2" color="#757575"><b>Click on the Search button above to see prospective students data <br />according to Student ID (Student ID) or Name based on <i>keyword</i></b></font>	
<br /><br />    </td>
</tr>
</table>
...
<tr>
	<td align="center" colspan="3">
	<input type="button" class="cmbfrm2" name="tutup" id="tutup" value="Close" onclick="window.close()" style="width:80px;"/>	</td>
</tr>
</table>