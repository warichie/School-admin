...
$from=$_REQUEST[from];
$to=$_REQUEST[to];
$sql = "SELECT p.idanggota, p.tglpinjam FROM pinjam p, daftarpustaka d, pustaka pu WHERE p.tglpinjam BETWEEN '$from' AND '$to' AND pu.replid = '$idpustaka' AND p.kodepustaka=d.kodepustaka AND d.pustaka=pu.replid";
$result = QueryDb($sql);
//echo $sql;
$cnt=1;
?>
