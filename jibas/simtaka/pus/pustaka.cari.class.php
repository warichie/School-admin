                      ...
                      <tr>
                        <td>
                            <select name="kategori" class="cmbfrm" id="kategori" onchange="chg_kat()">
                                ...
                                <option value="tahun" <?=StringIsSelected($this->kategori,'tahun')?> >Year Published</option>
...
<div align="right">
        ...
        <table width="100%" border="1" cellspacing="0" cellpadding="0" class="tab" id="table">
          <tr class="header" height="30">
            ...
            <td height="30" align="center">Ttile</td>
            <td height="30" align="center">Availability</td>
		  ...
		  if ($num>0){
			  ...
			  <tr>
				...
				<td align="center" bgcolor="#FFFFFF">
					...
					<a title="Print Label" href="javascript:cetak_nomor('<?=$row[0]?>','<?=$this->perpustakaan?>')"><img src="../img/ico/print1.png" width="16" height="16" border="0" /></a>
				</td>
