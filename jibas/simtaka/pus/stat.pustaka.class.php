...
class CStat{
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <div id="title" align="right">
                ...
                <font style="font-size:18px; color:#999999">Favorite Library Books Statistic</font><br />
                <a href="pustaka.php" class="welc">Library</a><span class="welc"> > Favorite Library Books Statistic</span><br /><br /><br />
            </div>
            </td>
          </tr>
          <tr>
	...
	function ShowStatistik(){
		...
		$sql = "SELECT count(*) as num, judul, pu.replid FROM pinjam p, daftarpustaka d, pustaka pu WHERE p.tglpinjam BETWEEN '".$this->ThnAwal."-".$this->BlnAwal."-01' AND '".$this->ThnAkhir."-".$this->BlnAkhir."-31' AND d.kodepustaka=p.kodepustaka AND pu.replid=d.pustaka $filter GROUP BY judul ORDER BY num DESC LIMIT ".$this->Limit;		
		$result = QueryDb($sql);
		//echo $sql;
		$cnt=1;
					...
					<td width="350" valign="top">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" class="tab">
						  ...
						  <tr>
							...
							<td height="20"><div style="padding-left:5px; padding-right:5px;"><?=$this->judul?></div></td>
