      ...
      // errno 1146 : Table '%s.%s' doesn't exist 
		...
		if ($_SESSION['issend'])
		{
	      $errstr .= "<p align='center'>
							Run <font style='text-weight:bold; color:green'><strong>JIBAS Live Update</strong></font> to fix the issue or find a solution at <a style='color:blue; text-decoration:underline;' target='_blank' href='http://forum.jibas.net'>JIBAS Forums</a>.
							If the issue persists, report the following error to <a style='color:blue; text-decoration:underline;' target='_blank' href='http://support.jibas.net'>JIBAS Support Center</a></p>\n";
		}
