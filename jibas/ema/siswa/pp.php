...
<tr>
    ...
    <tr>
        ...
        <select name="departemen" class="cmbfrm" id="departemen" style="width:80px" onChange="change_dep(2)">
		<? for ($i=0;$i<sizeof($dep);$i++) { ?>        	
            <option value="<?=$i ?>" <?=IntIsSelected($i, $departemen) ?> > <?=$dep[$i][0] ?> </option>
		<? } ?>
		</select>
        <select name="tahunajaran" class="cmbfrm" id="tahunajaran" style="width:125px" onChange="change_ta(2)">
        ...
        <select name="kelas" class="cmbfrm" id="kelas" style="width:125px" onChange="change_kls(2)">
        ...
        <td align="right" width="12%">
  			<a href="javascript:cetak(4)" ><img src="../img/print.png" width="16" height="16" border="0" />&nbsp;Print</a>
    	</td>
  	</tr>
<? if ($kelas<> "" ) { 
...
?>
         <tr>
            ...
            $data_title = "<span class=\"nav_title\">CLASS PRESENCE STATISTIC</span>"; // title for the diagram
