...
<tr>
    ...
    <table border="0" cellpadding="2"cellspacing="2" width="100%" style="color:#000000">
     <tr>
	     ...
	     <td width="*"> 
    	  <select name="departemen" class="cmbfrm" id="departemen" style="width:150px" onChange="change_dep(4)">
        ...
        <td>
         <select name="tahunajaran" class="cmbfrm" id="tahunajaran" style="width:150px" onChange="change_ta(4)">
    ...
    <tr>
	    <td width="19%" class="gry"><strong class="news_content1">Class History</strong></td>
       <td>
       <select name="kelas" class="cmbfrm" id="kelas" style="width:200px" onChange="change_kls(4)">
        ...
        <td>
        <select name="semester" class="cmbfrm" id="semester" style="width:200px" onChange="change_sem()">
...
<? if ($kelas <> "" && $semester <> "") 
    ...
    <tr>
    	<td colspan="4">
        <div align="right"><a href="javascript:cetak(6)"><img src="../img/print.png" border="0" />&nbsp;Print</a></div>
