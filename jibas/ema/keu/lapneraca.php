...
<?		if ($tgl1 == 0)	$tgl1 = $tgl2;
    ...
    <td rowspan="2" valign="middle">
        <a href="#" onclick="show_laporan()"><img src="../img/view.png" border="0" height="48" width="48" id="tabel" onmouseover="showhint('Click to show balance sheet reports', this, event, '180px')" /></a>    </td>
    <td width="30%" align="right" valign="top">
    <font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<span class="news_title2">Balance Sheet Reports</span>
    </td>
</tr>
</table>
</form>
