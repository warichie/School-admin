...
<td rowspan="3" width="60%">
    ...
    <tr>
    	<td class="news_content1">Category&nbsp;</td>
      	<td colspan="4">    
...
<?		if ($tgl1 == 0) $tgl1 = $tgl2;
 	...
 	<td rowspan="2" width="*" valign="middle">
        <a href="#" onclick="show_laporan()"><img src="../img/view.png" border="0" height="48"  width="48" id="tabel" onmouseover="showhint('Click to show data jurnal penerimaan', this, event, '120px')"/></a>    </td>
	<td width="40%" align="right" valign="top">
    	<font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font color="Gray" size="4" face="Verdana, Arial, Helvetica, sans-serif" class="news_title2">Admission Journal</font>
	  </td>
</tr>
<tr>	
