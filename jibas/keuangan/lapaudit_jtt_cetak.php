...
while ($row = mysql_fetch_array($result)) {
	...
	<tr>
        ...
        <td colspan="7" align="left" bgcolor="#CCCC66"><em><strong>Changed by <?=$row['petugasubah'] . " tanggal " . $row['tanggalubah'] ?></strong></em></td>
	</tr>
    <tr>
    	<td colspan="7" bgcolor="#E5E5E5"><strong>Journal Number :</strong> <?=$row['nokas'] ?>   
