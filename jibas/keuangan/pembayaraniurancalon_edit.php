...
<title>JIBAS SIMKEU [Edit Payment Contribution Student Candidate]</title>
...
function validasiAngka() 
{
	...
	{
		alert ('Besarnya pembayaran should not be a negative number');
		document.getElementById('jcicilan').focus();
		return false;
	}
	return true;
...
<tr height="150">
	...
	<!-- TABLE CONTENT -->
   	<tr height="25">
        <td colspan="3" class="header" align="center">Edit Payment</td>
    </tr>
    <tr>
