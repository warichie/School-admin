...
{	
//alert ('woi');
newWindow('pembayaranjtt_tunggak_add.php?idpenerimaan=<?=$idpenerimaan?>&idkategori=<?=$idkategori?>&nis=<?=$nis?>&idtahunbuku=<?=$idtahunbuku?>&idtahunbuku_aktif=<?=$idtahunbuku_aktif?>','tes','405','340','resizable=1,scrollbars=1,status=0,toolbar=0');
}
