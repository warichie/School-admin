  	...
  	<table width="100%" border="0" height="100%" cellspacing="0" cellpadding="0">
   	<tr>
		<td><font size="2" color="#990000">
        	<strong>Student Contribution Admission Data Changing <?=$judul?> </strong></font>
        </td>
        <td align="right">
        <a href="#" onClick="document.location.reload()"><img src="images/ico/refresh.png" border="0" onMouseOver="showhint('Refresh', this, event, '50px')" />&nbsp;Refresh</a>&nbsp;
        <a href="JavaScript:cetak()"><img src="images/ico/print.png" border="0" onMouseOver="showhint('Refresh', this, event, '50px')"/>&nbsp;Print</a>&nbsp;
