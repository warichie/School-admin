...
<?		if ($tgl1 == 0)	$tgl1 = $tgl2;
    ...
    <td rowspan="3" valign="middle">
    	<a href="#" onclick="show_laporan()"><img src="images/view.png" border="0" height="48" width="48" id="tabel" onmouseover="showhint('Click to show data laporan buku besar', this, event, '180px')" /></a>
    </td>
    <td width="30%" align="right" valign="top">
    	<font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Ledger Reports</font><br />
    	<a href="lapkeuangan.php" target="_parent">
      	<font size="1" color="#000000"><b>Finance Reports</b></font></a>&nbsp;>&nbsp;
        <font size="1" color="#000000"><b>Ledger Reports</b></font>
	</td>
</tr>
</table>
</form>
