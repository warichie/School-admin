...
<?		if ($tgl1 == 0)	$tgl1 = $tgl2;
	...
	<td rowspan="2" valign="middle">
    	<a href="#" onclick="show_laporan()"><img src="images/view.png" border="0" height="48" width="48" id="tabel" onmouseover="showhint('Click to show finance data changing audit reports', this, event, '220px')" /></a>
    </td>
    <td width="40%" align="right">
    	<font size="4" face="Verdana, Arial, Helvetica, sans-serif" style="background-color:#ffcc66">&nbsp;</font>&nbsp;<font size="4" face="Verdana, Arial, Helvetica, sans-serif" color="Gray">Audit Reports<br />Finance Data Changing</font><br />
    	<a target="_parent" href="lapkeuangan.php">
      	<font size="1" color="#000000"><b>Finance Reports</b></font></a>&nbsp;>&nbsp;
        <font size="1" color="#000000"><b>Data Changing Audit Reports</b></font>
	</td>
</tr>
</table>
</form>
