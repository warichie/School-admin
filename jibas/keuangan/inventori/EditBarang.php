...
<legend style="background-color:#336699; color:#FFFFFF; font-size:10px; font-weight:bold; padding:5px">&nbsp;Change&nbsp;Item&nbsp;</legend>
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  ...
  <tr>
    <td colspan="3" align="center"><input name="Simpan" type="submit" class="but" value="Save" />
