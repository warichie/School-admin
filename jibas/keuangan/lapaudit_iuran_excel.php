...
$filename = "Laporan_Audit_Iuran_".$judul2."Student.xls";
/**/
...
<title>JIBAS FINANCE [Data Changing Audit Reports Contribution <?=$judul?> Student]</title>
</head>
...
while ($row = mysql_fetch_array($result)) {
    ...
    <tr>
    	<td colspan="6" bgcolor="#E5E5E5"><font size="2" face="Arial"><strong>Journal Number :</strong> 
        <?=$row['nokas'] ?>
